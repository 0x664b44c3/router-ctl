#ifndef QUARTZPROTOCOL_H
#define QUARTZPROTOCOL_H
...
class QuartzProtocolDriver : public IOStreamBusDriverBase
{
public:
    QuartzProtocolDriver(QString busId, QObject * = nullptr);
